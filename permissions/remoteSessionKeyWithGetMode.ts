...
import { http, createPublicClient, zeroAddress, Hex } from "viem"
...
if (
    ...
    !process.env.REMOTE_SESSION_KEY_WALLET_ADDRESS
) {
    throw new Error(
        "BUNDLER_RPC or PAYMASTER_RPC or PRIVATE_KEY or ZERODEV_API_KEY or REMOTE_SESSION_KEY_WALLET_ADDRESS is not set"
    )
}
...
const walletAddress = process.env.REMOTE_SESSION_KEY_WALLET_ADDRESS as Hex
